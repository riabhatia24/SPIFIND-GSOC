		...
		return (
				<Scene>
                    ...
                    <Sobject name={'book'} xPos={380} yPos={410}>
						<img src="https://media.giphy.com/media/13C8OJmeUxGz4Y/giphy.gif" height="120" />
					</Sobject>
					<Sobject name={'painting'} xPos={726} yPos={80}>
						<img src={Painting} height="150" />
					</Sobject>
					<Sobject name={'fan'} xPos={1246} yPos={140}>
						<img src="http://www.animatedimages.org/data/media/1183/animated-fan-image-0004.gif" height="250" />
					</Sobject>
